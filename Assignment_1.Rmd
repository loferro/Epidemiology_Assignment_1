...
Now we have obtained a model in which all regressor seem to be significant. We save the residuals of our linear model and look at the de-trended data:
...
lines(poly84, lwd=2)
legend('topright', pch = 16, c("1st", "2nd", "3rd", "4th"), col=c('red', 'green', 'blue', 'black'))
```
