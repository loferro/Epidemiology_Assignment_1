...
wls.matern <- variofit(variogramma, cov.model = "matern", ini = c(86, 11), fix.nugget = F, fix.kappa = FALSE, kappa = 0.5, weights = "cressie")
```
...
```{r cache=TRUE, include=FALSE}
lk.exponential <- likfit(geodataset.residuals, cov.model = "exponential", ini = c(91, 25), lik.method = "ML")

lk.gaussian <- likfit(geodataset.residuals, cov.model = "gaussian", ini = c(86, 8), lik.method = "ML")

lk.spherical <- likfit(geodataset.residuals, cov.model = "spherical", ini = c(91, 22), lik.method = "ML")
...
```{r cache=T}
lk.matern <- likfit(geodataset.residuals, cov.model = "matern", ini = c(86, 11), fix.nugget = F, fix.kappa = FALSE, kappa = 1, lik.method = "ML")
lk.matern
