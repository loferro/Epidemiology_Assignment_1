...
```{r  results = "hide"}
#contour(kc.gaussian,filled= TRUE,coords.data=geodataset$coords, col=terrain.colors(31), xlim=range(poly84$x), ylim=range(poly84$y), borders = poly84, main = "Plot of predictions")
